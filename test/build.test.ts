...
<plist version="1.0">
  <real>3.141592653589793</real>
    ...
    it('should create a plist XML real from a BigInt', () => {
...
<plist version="1.0">
  <date>2010-02-08T21:41:23Z</date>
    ...
    it('should create a plist XML data from a Uint8Array', () => {
...
<plist version="1.0">
  <dict>
    ...
    it('should pass xmlbuilder create options', () => {
      const content = { ['bad\u0001key']: 'hello\u0001world' };

      expect(() => build(content)).toThrow(/Invalid character/);
